...
namespace Nakama {
	...
	// OnSuccess returns: NResultSet<NNotification>*
	class NAKAMA_API NNotificationsListMessage : public INCollatedMessage
	{
	private:
		Envelope envelope;
	...
	class NAKAMA_API NNotificationsListMessage::Builder
	{
	private:
